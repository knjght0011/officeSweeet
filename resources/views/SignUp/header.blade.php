...
<head>
    ...
    <title>Office Sweeet Signup</title>
    ...
    <script type="text/javascript" src="{{ url('/includes/jquery-3.1.0.min.js') }}"></script>
    <script type="text/javascript" src="{{ url('/includes/jquery-ui.js') }}"></script>
    <script type="text/javascript" src="{{ url('/includes/bootstrap/js/bootstrap.min.js') }}"></script>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-108705960-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-108705960-1');
    </script>
