...
<div class="modal fade bd-example-modal-sm" id="send-popup-compose-email-client-tab-choose-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <button type="button" data-toggle='modal' data-dismiss="modal" href='#send-popup-compose-email-client-tab-modal' id="send-popup-compose-email-client-tab-modal-click" class="btn btn-outline-primary btn-lg btn-block">Send email from scratch</button>
...
<script>
    $(document).ready(function () {
        ...
        $('#send-popup-compose-email-client-tab-choose-modal').on('show.bs.modal', function (event) {
            ...
            $('#send-popup-compose-email-client-tab-choose-modal').data('email', email);
            $('#send-popup-compose-email-client-tab-choose-modal').data('link_id', client_contact_id);
        ...
        $('#send-popup-compose-email-client-tab-modal').on('show.bs.modal', function (event) {
            var email =  $('#send-popup-compose-email-client-tab-choose-modal').data('email');
            var client_contact_id = $('#send-popup-compose-email-client-tab-choose-modal').data('contact_id');
            var recipient_id = $('#send-popup-compose-email-client-tab-choose-modal').data('recipient_id');
            // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
            // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
