...
<head>
    ...
    <style type="text/css">
        ...
        #toaddess {
            position: absolute;
        @if(SettingHelper::GetSetting('toleft') != null);
            left: {{ SettingHelper::GetSetting('toleft') - 5 }}mm;
            @else
left: 20mm;
        @endif

        @if(SettingHelper::GetSetting('totop') != null);
            top: {{ SettingHelper::GetSetting('totop') - 5 }}mm;
            @else
top: 45mm;
        @endif

        @if(SettingHelper::GetSetting('towidth') != null);
            width: {{ SettingHelper::GetSetting('towidth') }}mm;
            @else
width: 70mm;
        @endif

        @if(SettingHelper::GetSetting('toheight') != null);
            height: {{ SettingHelper::GetSetting('toheight') }}mm;
            @else
height: 20mm;
            @endif
...
padding: 5px;
        ...
        #returnaddress {
            position: absolute;
        @if(SettingHelper::GetSetting('returnleft') != null);
            left: {{ SettingHelper::GetSetting('returnleft') - 5 }}mm;
            @else
left: 10mm;
        @endif

        @if(SettingHelper::GetSetting('returntop') != null);
            top: {{ SettingHelper::GetSetting('returntop') - 5 }}mm;
            @else
top: 20mm;
        @endif

        @if(SettingHelper::GetSetting('returnwidth') != null);
            width: {{ SettingHelper::GetSetting('returnwidth') }}mm;
            @else
width: 50mm;
        @endif

        @if(SettingHelper::GetSetting('returnheight') != null);
            height: {{ SettingHelper::GetSetting('returnheight') }}mm;
            @else
height: 20mm;
            @endif
