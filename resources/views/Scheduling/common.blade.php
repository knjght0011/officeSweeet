...
$( document ).ready(function() {
    ...
    $('#display-userid').change(function () {
        $('.calload').css('display','block');
        GoToPage('/Scheduling/View/' + this.value);
    });
});
...
function SaveEventData($newevent, event, $refresh){
    ...
    posting.done(function( data ) {
        ...
        switch(data['status']) {
            case "OK":
                ...
                //SavedSuccess($content = 'Saved', $title = "Success!", $timeout = "1000");
                break;
            case "notlogedin":
                NotLogedIN();
                break;
