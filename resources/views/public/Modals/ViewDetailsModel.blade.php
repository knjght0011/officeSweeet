                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="NoteModal-Event">
                            ...
                            <div class="input-group ">
                                <span class="input-group-addon" for="event-userid" readonly><div style="width: 15em;">User:</div></span>
                                <select id="event-userid" name="event-userid" class="form-control" readonly>
                                    <option value="0">None</option>
                                </select>
                            </div>

                            <div class="input-group ">
                                <span class="input-group-addon" for="repeat" readonly><div style="width: 15em;">Repeat:</div></span>
...
$( document ).ready(function() {
    ...
    $("#NotifyUser1").click(function(e) {
        ...
        SendNotification($subject, $message, $event['resourceId']);
    });
...
@include('public.Modals.LinkedAccountModel')