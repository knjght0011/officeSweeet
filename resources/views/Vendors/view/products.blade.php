<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
    ...
    <div class="col-md-3">
        <button style="width: 100%;" type="button" class="btn OS-Button" data-toggle="modal" data-mode="edit" data-target="#UploadProducts">
            Bulk Product Upload
        </button>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group ">
                    ...
                    <input id="productname" name="productname" type="text" placeholder="" value="" class="form-control">
                </div>
                ...
                <div class="input-group ">
                    ...
                    <input id="sku" name="sku" type="text" placeholder="" value="" class="form-control">
                </div>

                <div class="input-group ">
                    <span class="input-group-addon" for="charge"><div style="width: 15em;">Charge:</div></span>
                    <input id="charge" name="charge" type="text" placeholder="" value="" class="form-control numonly">
                </div>

                <div class="input-group ">
                    <span class="input-group-addon" for="cost"><div style="width: 15em;">Cost:</div></span>
                    <input id="cost" name="cost" type="text" placeholder="" value="" class="form-control numonly">
                </div>
                ...
                <div class="input-group ">
                    ...
                    <input type="checkbox" name="checkboxes" id="taxable" data-on="Yes" data-off="No"
                           data-toggle="toggle" data-width="100%" class="" checked>
                </div>
...
<!--<form action="" method="post" enctype="multipart/form-data">-->
    <div class="modal fade" id="UploadProducts" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <p>Please upload a product list in CSV format.</p>
                    <input name="_token" type="hidden" value="{{ csrf_token() }}">
                    <input style="width: 100%;" type="file" class="btn OS-Button btn-sm" name="productFileToUpload" id="productFileToUpload">
                </div>
                <div class="modal-footer">
