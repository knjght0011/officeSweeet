...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-7 col-md-7">
            <div class="form-group">
                <label style="width: 100%;" for="cardExpiry"><span class="hidden-xs">EXPIRATION</span><span
    ...
    <div class="row">
        <div class="col-xs-12">
            <button id="submit" class="btn btn-success btn-lg btn-block" type="submit">Pay ${{ number_format($promotion->cost, 2, , '.', '') }} Now
            </button>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        $('#submit').click(function () {
            ...
            values['number_of_users'] = "{{ $promotion->numusers }}";
            values['referalcode'] = "{{ $promotion->tn_plan_name }}";
