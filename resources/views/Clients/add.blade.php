...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="input-group" >
            <span class="input-group-addon" for="name"><div class="inputdiv">Business Name (optional):</div></span>
    ...
    <div class="col-md-6">
        ...
        <div id="contact_contaner">
            ...
            <div class="input-group ">
                ...
                <input id="contactemail" name="contactemail" type="text" value="" class="form-control" >
            </div>
