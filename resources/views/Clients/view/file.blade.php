                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="margin-top: 0px;">
                                ...
                                <li><a href="#" data-toggle="modal" data-target="#send-client-email-modal" data-mode="button"  data-link_id="{{ $report->id }}" data-type="Document" data-subject="">Email Document</a></li>
