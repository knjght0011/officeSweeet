        ...
        <div class="col-md-3">
            <div class="input-group ">
                ...
                <select id="patient-action-select" name="invoice-status" type="text" placeholder="choice" class="form-control">
                    ...
                    <option value="edit" selected>Edit Patient</option>
                    <option value="schedule">Add To Schedule</option>
                </select>
    ...
    <table id="patientsearch" class="table">
        ...
        @foreach($patient as $pt)
            <tr>
                ...
                <td><a href="tel:{{ $pt->mobilenumber }}">{{ $pt->mobilenumber }}</a></td>
                <td><a href="tel:{{ $pt->homenumber }}">{{ $pt->homenumber }}</a></td>
                <td>{{ $pt->email }}</td>
                <td>{{ $pt->comments }}</td>
                @if($pt->address_id == NULL)
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    ...
                    <td></td>
                @else
                    <td>{{ $pt->address->number }}</td>
                    <td>{{ $pt->address->address1 }}</td>
                    <td>{{ $pt->address->address2 }}</td>
                    <td>{{ $pt->address->city }}</td>
                    <td>{{ $pt->address->state }}</td>
                    <td>{{ $pt->address->zip }}</td>
                @endif
                <td><a href="/Clients/View/{{ $pt->client_id }}">{{ $pt->client->name }}</a></td>
                <td>{{ $pt->client_id }}</td>
            </tr>
        @endforeach
        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input id="client-id" name="client-id" type="hidden" placeholder="0" class="form-control" required="" disabled>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
                ...
                switch ($('#patient-action-select').val()) {
                    ...
                    case "edit":
                        ...
                        if($row === undefined){
                            ...
                            $('#patient-mobilenumber').val($row['mobilenumber'].replace(/(<([^>]+)>)/ig,""));
                            $('#patient-homenumber').val($row['homenumber'].replace(/(<([^>]+)>)/ig,""));
            ...
            $('#patient-save').click(function () {
                ...
                $data['mobilenumber'] = $('#patient-mobilenumber').val().replace(/(<([^>]+)>)/ig,"");
                $data['homenumber'] = $('#patient-homenumber').val().replace(/(<([^>]+)>)/ig,"");
