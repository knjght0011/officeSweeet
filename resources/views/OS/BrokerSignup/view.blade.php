    ...
    <div class="container">
        ...
        <div class="input-group">
            ...
            <select
                    ...
                    class="form-control"
            >
                <option value="Sept2018_Upto3">Up to 3 Users @ $47 per month</option>
                <option value="Sept2018_Upto9">Up to 9 Users @ $97 per month</option>
                <option value="Sept2018_Unlimited" selected>Unlimted Users @ $197 per month</option>
            </select>
        </div>
...
$(document).ready(function() {
    ...
    $('#submit').click(function () {
        ...
        $post = $.post("/Signup/Subscribe", $data);
