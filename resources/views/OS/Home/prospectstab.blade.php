    ...
    $(document).ready(function () {
        ...
        window.prospectstable = $('#prospects-table').DataTable({
            ...
            "columns": [
                ...
                { "data": "email", "name":"clientcontacts.email", "searchable": false, "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) { $(nTd).html("<a data-toggle='modal' href='#send-popup-compose-email-prospect-tab-modal' data-recipient-id='"+oData.id+"' data-client-contact-id='"+oData.primarycontact_id+"' data-mail='"+oData.email+"' class='email'>"+oData.email+"</a>");}},
