...
// Initial Setting Functions
    function __construct() {
        if(SettingHelper::GetSetting('transnational-username') != null & SettingHelper::GetSetting('transnational-password') != null){
            $this->setLogin(SettingHelper::GetSetting('transnational-username'), SettingHelper::GetSetting('transnational-password'));
        }
    }  
    ...
    function setOrder($orderid,$orderdescription,$tax,$ipaddress) {
  ...
  // Transaction Functions
    ...
    function doSale($amount, $ccnumber, $ccexp, $cvv="") {
      ...
      $query .= "phone=12345678912";# . urlencode($this->billing['phone']) . "&";
      // Order Information
