...
// http://github.com/stimpy77/xhtml.js/LICENSE
				...
				if (!strict || window.xhtmljs.tagInXhtml(tagName.toLowerCase())) {
					...
					if (attributes) {
						...
						for (i = 0; i < attributes.length; i++) {
							...
							attribValue.trim() != "" &&
							attribValue != "inherit" &&
							(!strict || window.xhtmljs.attribInXhtml(tagName.toLowerCase(), attribName.toLowerCase(), attribValue))) {
						...
						if (!styleTagUsed && (!strict || window.xhtmljs.attribInXhtml(tagName.toLowerCase(), "style")) &&
						el.style.cssText) {
